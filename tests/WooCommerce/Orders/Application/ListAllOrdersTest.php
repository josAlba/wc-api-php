...
namespace WooCommerce\Orders\Application;

use Automattic\WooCommerce\Orders\Application\ListAllOrders;
...
class ListAllOrdersTest extends TestCase
{
    ...
    public function test(): void
    {
        ...
        $allOrders = (new ListAllOrders())($client);

        self::assertNotEmpty($allOrders);
        self::assertCount(2, $allOrders);
        self::assertEquals(727, $allOrders[0]->id);
    }
